...
export default function SectionFlashcardsPage() {
 ...
 <Link
 href="/dashboard/flashcards"
 className="inline-flex items-center text-sm text-[var(--muted)] hover:text-gray-800 dark:hover:text-gray-200 mb-6"
 >
 ...
 {/* Header */}
 <div className="bg-white dark:bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 mb-6">
 ...
 <div className="bg-gray-50 dark:bg-[var(--background)] rounded-lg p-3">
 <p className="text-2xl font-bold text-[var(--foreground)]">{cards.length}</p>
 ...
 <p className="text-sm text-[var(--muted)]">Mastered</p>
 </div>
 </div>
 ...
 <span className="font-medium text-[var(--foreground)]">{masteredPercentage}%</span>
 </div>
 ...
 {/* Topics Section */}
 <div className="bg-white dark:bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
 ...
 <div
 key={topic}
 className="flex items-center justify-between p-3 bg-gray-50 dark:bg-[var(--background)] rounded-lg"
 >
 <div>
 <p className="font-medium text-[var(--foreground)]">{topic}</p>
 ...
 <div className="mt-6 bg-white dark:bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
 <h2 className="text-lg font-semibold text-[var(--foreground)] mb-4">
 Sample Cards
 </h2>
 ...
 <p className="text-[var(--foreground)] font-medium">{card.front}</p>
 <p className="text-sm text-[var(--muted)] mt-1">{card.topic}</p>
 </div>
