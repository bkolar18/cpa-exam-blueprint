...
export default function SectionPage() {
 ...
 <h1 className="text-xl font-semibold text-gray-800 dark:text-[var(--foreground)] mb-2">
 Section Not Found
 </h1>
 ...
 <Link
 href="/dashboard/simulations"
 className="text-gray-500 dark:text-[var(--muted)] hover:text-[var(--primary)]"
 >
 Simulations
 </Link>
 </li>
 <li className="text-gray-400 dark:text-[var(--muted)]">/</li>
 <li className="text-gray-800 dark:text-[var(--foreground)] font-medium">
 {sectionParam}
 </li>
 </ol>
 </nav>
 ...
 <p className="text-xs text-gray-500 dark:text-[var(--muted)]">Total TBS</p>
 <p className="text-2xl font-bold text-[var(--primary)]">{sectionStats.total}</p>
 </div>
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-[var(--border)] p-4">
 <p className="text-xs text-gray-500 dark:text-[var(--muted)]">Completed</p>
 <p className="text-2xl font-bold text-green-600 dark:text-green-400">
 {progressLoading ?"—": sectionStats.completed}
 </p>
 </div>
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-[var(--border)] p-4">
 <p className="text-xs text-gray-500 dark:text-[var(--muted)]">Avg Score</p>
 ...
 <span className="text-sm text-gray-500 dark:text-[var(--muted)]">Sort:</span>
 <select
 value={sortBy}
 onChange={(e) => setSortBy(e.target.value as"title"|"time"|"topic")}
 className="px-3 py-2 bg-white dark:bg-[var(--card)] border border-[var(--border)] rounded-lg text-sm text-gray-700 dark:text-[var(--muted-light)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
 >
 ...
 <div className="text-center py-12 bg-white dark:bg-[var(--card)] rounded-xl border border-[var(--border)]">
 <svg
 ...
 className="px-3 py-2 text-sm bg-white dark:bg-[var(--card)] border border-[var(--border)] rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:border-[var(--primary)] transition-colors"
 >
 Previous
 </button>
 ...
 :"bg-white dark:bg-[var(--card)] border border-[var(--border)] hover:border-[var(--primary)]"
 }`}
 >
 {page}
 </button>
