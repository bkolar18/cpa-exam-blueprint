        ...
        <>
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                      filterType === "return_to"
                        ...
                        : "bg-gray-100 dark:bg-gray-700 text-[var(--foreground)] hover:bg-blue-100 dark:hover:bg-blue-900/30"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                      filterType === "difficult"
                        ...
                        : "bg-gray-100 dark:bg-gray-700 text-[var(--foreground)] hover:bg-red-100 dark:hover:bg-red-900/30"
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                      filterType === "easy"
                        ...
                        : "bg-gray-100 dark:bg-gray-700 text-[var(--foreground)] hover:bg-green-100 dark:hover:bg-green-900/30"
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            {filteredQuestions.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-6 text-center">
              ...
              filteredQuestions.map((fq) => (
                <div
                  key={fq.id}
                  className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4"
                >
                  {/* Header */}
