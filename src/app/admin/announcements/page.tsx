  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg border border-[var(--border)] dark:border-gray-600 bg-white dark:bg-gray-700 text-[var(--foreground)] dark:text-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full px-3 py-2 rounded-lg border border-[var(--border)] dark:border-gray-600 bg-white dark:bg-gray-700 text-[var(--foreground)] dark:text-white placeholder:text-[var(--muted)] dark:placeholder:text-gray-500 resize-none font-mono text-sm"
            />
            <p className="text-xs text-[var(--muted)] dark:text-gray-400 mt-1">
          ...
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="px-4 py-2 border border-[var(--border)] dark:border-gray-600 text-[var(--foreground)] dark:text-white rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
        ...
        {/* Preview */}
        {showPreview && (
          <div className="mt-6 border-t border-[var(--border)] dark:border-gray-700 pt-6">
            <h3 className="text-sm font-semibold text-[var(--muted)] dark:text-gray-400 uppercase mb-3">
              Email Preview
            </h3>
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
              <div className="mb-4 pb-4 border-b border-[var(--border)] dark:border-gray-600">
                <p className="text-sm text-[var(--muted)] dark:text-gray-400">
                  <strong>From:</strong> CPA Exam Blueprint &lt;noreply@cpa-exam-blueprint.com&gt;
                </p>
                <p className="text-sm text-[var(--muted)] dark:text-gray-400">
              ...
              <div className="prose dark:prose-invert prose-sm max-w-none">
                {body ? (
                  ...
                  <p className="text-[var(--muted)] dark:text-gray-400 italic">(No message body)</p>
                )}
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-[var(--muted)] dark:text-gray-400">No announcements sent yet</p>
          </div>
        ) : (
          <div className="space-y-4">
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-[var(--muted)] dark:text-gray-400 mt-1 line-clamp-2">
                      {announcement.body}
                    </p>
                  </div>
                  <div className="text-right text-sm">
                    ...
                    <p className="text-[var(--muted)] dark:text-gray-400">
