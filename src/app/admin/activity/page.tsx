...
const actionTypeLabels: Record<string, { label: string; color: string }> = {
  ...
  export: { label: 'Data Export', color: 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300' },
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 overflow-hidden">
        {loading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-[var(--muted)] dark:text-gray-400">Loading activity logs...</p>
          </div>
        ) : logs.length === 0 ? (
          <div className="p-8 text-center">
            <ListIcon className="h-12 w-12 mx-auto text-[var(--muted)] dark:text-gray-600 mb-4" />
            <p className="text-[var(--muted)] dark:text-gray-400">No activity logs found</p>
          </div>
        ) : (
                  ...
                  return (
                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                      ...
                      <td className="px-4 py-3">
                        ...
                        {log.ip_address && (
                          <div className="text-xs text-[var(--muted)] dark:text-gray-400 font-mono">
                            {log.ip_address}
                          </div>
                        )}
                      </td>
                      ...
                      <td className="px-4 py-3">
                        ...
                        {log.target_id && (
                          <div className="text-xs text-[var(--muted)] dark:text-gray-400 font-mono truncate max-w-[150px]">
                            {log.target_id}
                          </div>
                        )}
                      </td>
                      <td className="px-4 py-3">
                        <div className="text-xs text-[var(--muted)] dark:text-gray-400 max-w-[200px] truncate" title={formatDetails(log.details)}>
