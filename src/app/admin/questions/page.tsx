...
export default function QuestionAnalyticsPage() {
 ...
 <div className="text-sm text-[var(--muted)] dark:text-[var(--muted)]">Questions with Data</div>
 </div>
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-red-200 dark:border-red-800 p-4">
 <div className="text-2xl font-bold text-red-600">{tooHardQuestions}</div>
 <div className="text-sm text-[var(--muted)] dark:text-[var(--muted)]">Too Hard (&lt;50%)</div>
 </div>
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-yellow-200 dark:border-yellow-800 p-4">
 <div className="text-2xl font-bold text-yellow-600">{tooEasyQuestions}</div>
 <div className="text-sm text-[var(--muted)] dark:text-[var(--muted)]">Too Easy (&gt;95%)</div>
 </div>
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-orange-200 dark:border-orange-800 p-4">
 <div className="text-2xl font-bold text-orange-600">{flaggedQuestions}</div>
 <div className="text-sm text-[var(--muted)] dark:text-[var(--muted)]">Has Feedback</div>
 </div>
 </div>
 ...
 <p className="mt-2 text-[var(--muted)] dark:text-[var(--muted)]">Loading questions...</p>
 </div>
 ) : filteredQuestions.length === 0 ? (
 <div className="p-8 text-center">
 <QuestionIcon className="h-12 w-12 mx-auto text-[var(--muted)] dark:text-gray-600 mb-4"/>
 <p className="text-[var(--muted)] dark:text-[var(--muted)]">No question data found</p>
 ...
 {question.topic && (
 <div className="text-xs text-[var(--muted)] dark:text-[var(--muted)] truncate max-w-[200px]">
 {question.topic}
 </div>
 )}
 </td>
 ...
 <div className="ml-2 w-16 bg-gray-200 dark:bg-[var(--card-hover)] rounded-full h-1.5">
 <div
 ...
 <span className="text-sm text-[var(--muted)] dark:text-[var(--muted)]">-</span>
 )}
 </td>
 <td className="px-4 py-3">
