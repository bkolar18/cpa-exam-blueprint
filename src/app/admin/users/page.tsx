    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4">
          ...
          <div className="text-sm text-[var(--muted)] dark:text-gray-400">Total Users</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4">
          ...
          <div className="text-sm text-[var(--muted)] dark:text-gray-400">Paid Users</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4">
          ...
          <div className="text-sm text-[var(--muted)] dark:text-gray-400">Active (7d)</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4">
          ...
          <div className="text-sm text-[var(--muted)] dark:text-gray-400">Avg Streak</div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 overflow-hidden">
        {loading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-[var(--muted)] dark:text-gray-400">Loading users...</p>
          </div>
        ) : filteredUsers.length === 0 ? (
          <div className="p-8 text-center">
            <UsersIcon className="h-12 w-12 mx-auto text-[var(--muted)] dark:text-gray-600 mb-4" />
            <p className="text-[var(--muted)] dark:text-gray-400">No users found</p>
          </div>
        ) : (
              ...
              <tbody className="divide-y divide-[var(--border)] dark:divide-gray-700">
                {filteredUsers.map((user) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="text-xs text-[var(--muted)] dark:text-gray-400">
                            {user.email}
                          </div>
                        </div>
                      </div>
                    ...
                    <td className="px-4 py-3 text-sm text-[var(--muted)] dark:text-gray-400">
      ...
      {selectedUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-lg mx-4 bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border)] dark:border-gray-700">
              ...
              >
                <XIcon className="w-5 h-5 text-[var(--muted)] dark:text-gray-400" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-[var(--muted)] dark:text-gray-400">
                    {selectedUser.email}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                  <div className="text-sm text-[var(--muted)] dark:text-gray-400">Subscription</div>
                  <div className="font-medium text-[var(--foreground)] dark:text-white capitalize">
                    {selectedUser.subscription_tier || 'Free'}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                  <div className="text-sm text-[var(--muted)] dark:text-gray-400">Joined</div>
                  <div className="font-medium text-[var(--foreground)] dark:text-white">
                    {new Date(selectedUser.created_at).toLocaleDateString()}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                  <div className="text-sm text-[var(--muted)] dark:text-gray-400">Last Active</div>
                  <div className="font-medium text-[var(--foreground)] dark:text-white">
                    {selectedUser.last_active ? formatRelativeTime(selectedUser.last_active) : 'Never'}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                  <div className="text-sm text-[var(--muted)] dark:text-gray-400">Practice Sessions</div>
                  <div className="font-medium text-[var(--foreground)] dark:text-white">
                    {selectedUser.practice_sessions_count || 0}
                  </div>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 col-span-2">
                  <div className="text-sm text-[var(--muted)] dark:text-gray-400">Current Streak</div>
              ...
              <div className="text-xs text-[var(--muted)] dark:text-gray-500">
