      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 overflow-hidden">
        {loading ? (
          <div className="p-8 text-center">
            ...
            <p className="mt-2 text-[var(--muted)] dark:text-gray-400">Loading feedback...</p>
          </div>
        ) : feedback.length === 0 ? (
          <div className="p-8 text-center">
            <FlagIcon className="h-12 w-12 mx-auto text-[var(--muted)] dark:text-gray-600 mb-4" />
            <p className="text-[var(--muted)] dark:text-gray-400">No feedback found</p>
          </div>
        ) : (
                  ...
                  <>
                    <tr
                      ...
                      className={`hover:bg-gray-50 dark:hover:bg-gray-700/50 ${
                        expandedId === item.id ? 'bg-gray-50 dark:bg-gray-700/50' : ''
                      }`}
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => setExpandedId(expandedId === item.id ? null : item.id)}
                            className="p-1 text-[var(--muted)] dark:text-gray-400 hover:text-[var(--foreground)] dark:hover:text-white"
                          >
                          ...
                          <div className="space-y-4">
                            {item.comment && (
                              <div>
                                ...
                                <p className="text-sm text-[var(--muted)] dark:text-gray-400 bg-white dark:bg-gray-800 p-3 rounded-lg border border-[var(--border)] dark:border-gray-600">
                                  {item.comment}
                                </p>
                              </div>
                            )}
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                rows={2}
                                className="w-full px-3 py-2 rounded-lg border border-[var(--border)] dark:border-gray-600 bg-white dark:bg-gray-800 text-[var(--foreground)] dark:text-white placeholder:text-[var(--muted)] dark:placeholder:text-gray-500 resize-none"
                              />
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              <span className="text-sm text-[var(--muted)] dark:text-gray-400 flex items-center ml-auto">
                                Edit question: <code className="ml-1 px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs">node scripts/question-editor.js edit {item.question_id}</code>
                              </span>
                            </div>
                          </div>
                        </td>
