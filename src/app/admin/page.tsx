    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[var(--muted)] dark:text-gray-400 mt-1">
          Overview of your CPA Exam Blueprint platform
        </p>
      </div>
        ...
        {statCards.map((stat) => (
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-[var(--muted)] dark:text-gray-400">
                  {stat.name}
                </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-6">
          ...
          {recentFeedback.length === 0 ? (
            <p className="text-[var(--muted)] dark:text-gray-400 text-center py-8">
                ...
                >
                  <div className="flex items-center min-w-0">
                    ...
                    <div className="ml-3 min-w-0">
                      ...
                      <p className="text-xs text-[var(--muted)] dark:text-gray-400 truncate">
                        {user.email}
                      </p>
                    </div>
                  </div>
                  <span className="text-xs text-[var(--muted)] dark:text-gray-400 whitespace-nowrap ml-2">
