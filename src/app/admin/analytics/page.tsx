    ...
    <div className="space-y-6">
            ...
            {(data?.accuracyBySection || []).map((item) => (
              <div key={item.section}>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-[var(--muted)] dark:text-gray-400">
          ...
          <div className="space-y-3">
            {(data?.topTopics || []).slice(0, 5).map((item, index) => (
              <div key={item.topic} className="flex items-center justify-between">
                <div className="flex items-center">
                  <span className="text-sm font-medium text-[var(--muted)] dark:text-gray-400 w-5">
                    {index + 1}.
                  </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-6">
          ...
          <div className="flex justify-between mt-2 text-xs text-[var(--muted)] dark:text-gray-400">
            <span>12am</span>
            <span>6am</span>
            <span>12pm</span>
            <span>6pm</span>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-[var(--border)] dark:border-gray-700 p-4">
      <div className="flex items-center">
        ...
        <div className="ml-3">
          <p className="text-sm text-[var(--muted)] dark:text-gray-400">{title}</p>
