...
export default function PricingPage() {
 ...
 :"bg-white dark:bg-[var(--card)] border border-[var(--border)]"
 }`}
 >
 {tier.badge && (
 <div
 ...
 <h3 className="font-bold text-lg mb-2">Meridian CPA Review</h3>
 ...
 <div
 key={index}
 className="bg-white dark:bg-[var(--card)] rounded-lg p-6 border border-[var(--border)]"
 >
