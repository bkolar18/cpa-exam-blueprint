...
export default function StudyPlanPage() {
 ...
 >
 <span className="text-lg font-semibold text-[var(--foreground)]">Yes</span>
 <p className="text-sm text-gray-600 dark:text-[var(--muted-light)] mt-1">
 ...
 >
 <span className="text-lg font-semibold text-[var(--foreground)]">No</span>
 <p className="text-sm text-gray-600 dark:text-[var(--muted-light)] mt-1">
 ...
 >
 <span className="text-lg font-semibold text-[var(--foreground)]">{option.label}</span>
 <p className="text-sm text-gray-600 dark:text-[var(--muted-light)] mt-1">{option.desc}</p>
 </button>
 ))}
 </div>
 </div>
 ...
 <span className="text-lg font-semibold text-[var(--foreground)]">{section.name}</span>
 </div>
 <p className="text-sm text-gray-600 dark:text-[var(--muted-light)] mt-2">{section.description}</p>
 <p className="text-sm text-gray-600 dark:text-[var(--muted-light)] mt-1">
 ...
 <div className="text-xs text-gray-500 dark:text-[var(--muted)]">Pass Rate</div>
 </div>
 </div>
 </button>
 )
 ...
 <div className="bg-gray-100 dark:bg-[var(--card-hover)] rounded-lg p-4 text-sm text-gray-600 dark:text-[var(--muted-light)]">
 ...
 className="w-full p-4 border-2 border-gray-200 dark:border-[var(--border)] rounded-xl bg-white dark:bg-[var(--card-hover)] text-[var(--foreground)] focus:border-[var(--primary)] focus:outline-none transition-colors"
 />
 <button
 ...
 <p className="text-sm text-gray-500 dark:text-[var(--muted)] text-center">
 ...
 <p className="text-gray-600 dark:text-[var(--muted-light)] mt-2">
 ...
 <div className="space-y-6">
 {/* Section Order */}
 <div className="bg-gray-50 dark:bg-[var(--card-hover)] p-6 rounded-xl border border-gray-200 dark:border-[var(--border)]">
 ...
 <span className="text-xs text-gray-500 dark:text-[var(--muted)] mt-1 block">
 {index === 0 ?"Start": index === 3 ?"Finish": `Step ${index + 1}`}
 </span>
 </div>
 {index < studyPlan.sectionOrder.length - 1 && (
 <svg className="w-6 h-6 text-gray-400 dark:text-[var(--muted)] mx-1"fill="none"stroke="currentColor"viewBox="0 0 24 24">
 ...
 <div className="bg-white dark:bg-[var(--border)] rounded-lg p-4">
 <div
 ...
 <div className="text-sm text-gray-600 dark:text-[var(--muted-light)]">Pass Rate</div>
 </div>
 <div className="bg-white dark:bg-[var(--border)] rounded-lg p-4 md:col-span-2">
 ...
 {/* CTA */}
 <div className="bg-gray-100 dark:bg-[var(--card-hover)] p-6 rounded-xl border border-gray-200 dark:border-[var(--border)] text-center">
 <h3 className="text-lg font-semibold text-[var(--foreground)] mb-2">
 Ready to start studying?
 </h3>
 <p className="text-gray-600 dark:text-[var(--muted-light)] mb-4">
 Track your progress and unlock achievements with your Meridian CPA Academy dashboard.
 </p>
 <div className="flex flex-col sm:flex-row gap-3 justify-center">
 <Link href="/signup"className="btn-primary inline-block">
 Sign Up for Meridian CPA Academy
 </Link>
 ...
 return (
 <div className="min-h-screen bg-gray-50 dark:bg-[var(--background)] py-12">
 <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
 {/* Progress bar */}
 {step <= totalSteps && (
 <div className="mb-8">
 <div className="flex justify-between text-sm text-gray-600 dark:text-[var(--muted)] mb-2">
 ...
 className="flex items-center text-gray-600 dark:text-[var(--muted)] hover:text-gray-900 dark:hover:text-white mb-6 transition-colors"
 >
 ...
 {/* Trust signal */}
 <p className="text-center text-sm text-gray-500 dark:text-[var(--muted)] mt-6">
