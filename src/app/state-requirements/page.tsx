        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Credit Hours (Most States)</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Month Testing Window</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {states.map((state) => (
              <Link
                ...
                className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-[var(--primary)] hover:shadow-md transition-all group"
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white group-hover:text-[var(--primary)] transition-colors">
                      {state.name}
                    </h3>
                ...
                <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-gray-600 dark:text-gray-400">Sit Early: </span>
                    <span className="font-medium">{state.examRequirements.canSitBeforeDegree ? "Yes" : "No"}</span>
                  </div>
                  <div>
                    <span className="text-gray-600 dark:text-gray-400">Ethics: </span>
