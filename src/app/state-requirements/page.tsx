        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="text-sm text-[var(--muted)]">Jurisdictions</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[var(--primary)]">150</div>
              <div className="text-sm text-[var(--muted)]">Credit Hours (Most States)</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-sm text-[var(--muted)]">Month Testing Window</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {states.map((state) => (
              <Link
                ...
                className="bg-white rounded-xl p-6 border border-[var(--border)] hover:border-[var(--primary)] hover:shadow-md transition-all group"
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-[var(--muted)]">Sit Early: </span>
                    <span className="font-medium">{state.examRequirements.canSitBeforeDegree ? "Yes" : "No"}</span>
                  </div>
                  <div>
                    <span className="text-[var(--muted)]">Ethics: </span>
          ...
          <div className="mt-12 bg-[var(--card)] rounded-xl p-6 border border-[var(--border)] text-center">
            ...
            <p className="text-[var(--muted)]">
              We&apos;re adding requirements for all 55 jurisdictions. Can&apos;t find your state?
              Check back soon or visit your state board directly.
            </p>
          </div>
        </div>
      </section>
