...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${state.name} CPA Requirements | CPA Exam Blueprint`,
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="bg-white rounded-xl p-6 border border-[var(--border)]">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className={`rounded-lg p-4 ${state.examRequirements.canSitBeforeDegree ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200"}`}>
                <div className={`text-lg font-bold ${state.examRequirements.canSitBeforeDegree ? "text-green-700" : "text-red-700"}`}>
                  {state.examRequirements.canSitBeforeDegree ? "Can Sit Early" : "Cannot Sit Early"}
                </div>
                <div className={`text-sm ${state.examRequirements.canSitBeforeDegree ? "text-green-600" : "text-red-600"}`}>
          ...
          <div className="bg-white rounded-xl p-6 border border-[var(--border)]">
            ...
            <div className={`rounded-lg p-4 ${state.ethicsExam.required ? "bg-yellow-50 border border-yellow-200" : "bg-green-50 border border-green-200"}`}>
              <div className={`text-lg font-bold ${state.ethicsExam.required ? "text-yellow-700" : "text-green-700"}`}>
          ...
          {/* CTA */}
          <div className="bg-white rounded-xl p-6 border border-[var(--border)] text-center">
