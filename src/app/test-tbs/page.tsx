...
export default function TestTBSPage() {
 ...
 return (
 <div className="min-h-screen bg-gray-100 dark:bg-[var(--background)] p-8">
 <div className="max-w-4xl mx-auto">
 <div className="mb-8">
 <h1 className="text-3xl font-bold text-gray-800 dark:text-[var(--foreground)] mb-2">
 TBS Test Page
 </h1>
 ...
 <div>
 <span className="text-gray-600 dark:text-[var(--muted)]">Score:</span>
 <span className="ml-2 font-medium text-blue-700 dark:text-blue-300">
 {lastAttempt.scorePercentage?.toFixed(0)}%
 </span>
 </div>
 <div>
 <span className="text-gray-600 dark:text-[var(--muted)]">Points:</span>
 <span className="ml-2 font-medium text-blue-700 dark:text-blue-300">
 {lastAttempt.scoreEarned} / {lastAttempt.maxScore}
 </span>
 </div>
 <div>
 <span className="text-gray-600 dark:text-[var(--muted)]">Time:</span>
 <span className="ml-2 font-medium text-blue-700 dark:text-blue-300">
 ...
 className="w-full text-left bg-white dark:bg-[var(--card)] border border-gray-200 rounded-xl p-4 hover:border-blue-500 hover:shadow-md transition-all"
 >
 ...
 <span className="px-2 py-0.5 text-xs font-medium bg-gray-100 dark:bg-[var(--card-hover)] text-gray-600 dark:text-[var(--muted)] rounded">
 ...
 <div className="text-sm font-medium text-gray-800 dark:text-[var(--foreground)]">
