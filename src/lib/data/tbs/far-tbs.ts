...
Required: Calculate the initial recognition amounts and Year 1 expense.`,
  ...
  requirements: [
    ...
    },
    {
      ...
      explanation: "Per ASC 842-20-35-7, ROU asset is amortized such that total lease cost is straight-line. Amortization = $48,000 - ($130,714 × 5%) = $41,464. Year-end balance = $178,714 - $41,464 ≈ $134,036",
    },
  ],
};
...
Required: Calculate the net pension expense components for Year 1.`,
  ...
  requirements: [
    ...
    },
    {
      ...
      explanation: "Per ASC 715-30-35-22, asset gain/loss = actual − expected return. $185,000 − $168,000 = $17,000 gain (to OCI)",
    },
    {
      id: "req-net-expense",
      order: 6,
