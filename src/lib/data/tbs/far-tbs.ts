  ...
  requirements: [
    {
      ...
      explanation: "FIFO ending = 100 units @ $28 + 50 units @ $25 = $2,800 + $1,250 = $4,050. Corrected: Actually 100 @ $28 = $2,800 + 50 @ $25 = $1,250 = $4,050... Let me recalculate: Remaining 150 units from latest: 100 @ $28 + 50 @ $25 = $2,800 + $1,250 = $4,050",
    },
    {
      id: "req-fifo-cogs",
      order: 2,
      ...
      explanation: "FIFO COGS = $13,100 - $4,050 = $9,050",
    },
    {
      id: "req-lifo-ei",
      order: 3,
...
Required: Calculate the required allowance balance and adjusting entry.`,
  ...
  requirements: [
    ...
    },
    {
      ...
      explanation: "$5,000 + $5,400 + $8,000 + $16,000 = $34,400",
    },
    {
      id: "req-adjustment",
      order: 3,
...
Required: Calculate basic and diluted EPS.`,
  ...
  requirements: [
    ...
    },
    {
      ...
      explanation: "Diluted shares = 540,000 + 18,750 + 60,000 + 25,000 = 643,750",
    },
    {
      id: "req-diluted-eps",
      order: 8,
      ...
      explanation: "Diluted EPS = ($840,000 + $120,000 + $60,000) / 643,750 = $1,020,000 / 643,750 = $1.58. Need to check anti-dilution...",
    },
  ],
};
