  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 842-20-30-1, lease liability equals PV of lease payments. PV = $48,000 × 3.7232 (PV annuity due, 4 periods, 5%) = $178,714",
    },
    {
      id: "req-rou-asset",
      order: 2,
      ...
      explanation: "Per ASC 842-20-30-1, ROU asset initially equals lease liability for operating leases: $178,714",
    },
    {
      ...
      explanation: "Per ASC 842-20-35-1, lease liability is reduced by payments. After first payment = $178,714 - $48,000 = $130,714",
    },
    {
      ...
      explanation: "Per ASC 842-20-25-6, operating lease expense is recognized on a straight-line basis: Total payments / Term = ($48,000 × 4) / 4 = $48,000",
    },
    {
      ...
      explanation: "Per ASC 842-20-35-7, ROU asset is amortized such that total lease cost is straight-line. Interest expense = $130,714 × 5% = $6,536. Amortization = $48,000 - $6,536 = $41,464. Year-end balance = $178,714 - $41,464 = $137,250",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 842-10-25-8, modifications not accounted for as separate leases require remeasurement at current discount rate. New liability = $42,000 × 3.4651 (4 periods, 6%) = $145,534",
    },
    {
      ...
      explanation: "Per ASC 842-10-25-11, the change in lease liability equals new liability minus old: $145,534 - $54,712 = $90,822",
    },
    {
      id: "req-new-rou",
      order: 3,
      ...
      explanation: "Per ASC 842-10-25-11, ROU asset is adjusted by same amount as liability change. New ROU = $52,000 + $90,822 = $142,822",
    },
    {
      ...
      explanation: "Per ASC 842-20-35-4, finance lease ROU is amortized over shorter of lease term or useful life. Annual depreciation = $142,822 / 4 years = $35,706",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 810-10-45-1, eliminate subsidiary's equity accounts against parent's investment in consolidation",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-1, eliminate subsidiary's beginning retained earnings as part of investment elimination entry",
    },
    {
      ...
      explanation: "Per ASC 805-20-25, assets acquired are recorded at fair value. Equipment FV adjustment = $100,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-1, credit investment account to eliminate against subsidiary equity and FV adjustments",
    },
    {
      ...
      explanation: "Per ASC 805-20-25, FV adjustments must be amortized post-acquisition. Equipment FV / Life = $100,000 / 10 = $10,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-1, eliminate 100% of intercompany sales in consolidation",
    },
    {
    ...
    },
    {
      ...
      explanation: "Per ASC 810-10-45-1, eliminate intercompany dividends. 100% of Sub's $20,000 dividend is eliminated",
    },
  ],
  journalAccounts: [
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 810-10-45-16, NCI is measured at fair value at acquisition date = $160,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-19, NCI share of income = subsidiary income × NCI% = $120,000 × 20% = $24,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-19, NCI share of FV amortization = $5,000 × 20% = $1,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-19, NCI adjusted income = gross share − amortization = $24,000 − $1,000 = $23,000",
    },
    {
      ...
      explanation: "Per ASC 810-10-45-19, NCI share of dividends = $40,000 × 20% = $8,000",
    },
    {
      id: "req-nci-ending",
      order: 6,
      ...
      explanation: "Per ASC 810-10-45-19, ending NCI = beginning + share of income − dividends = $160,000 + $23,000 − $8,000 = $175,000",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 715-30-35-4, service cost is the actuarial PV of benefits attributed to current period services: $195,000",
    },
    {
      ...
      explanation: "Per ASC 715-30-35-7, interest cost = beginning PBO × discount rate = $2,400,000 × 6% = $144,000",
    },
    {
      ...
      explanation: "Per ASC 715-30-35-8, expected return = plan assets × expected return rate = $2,100,000 × 8% = $168,000",
    },
    {
      id: "req-psc-amort",
      order: 4,
      ...
      explanation: "Per ASC 715-30-35-11, prior service cost is amortized over remaining service period = $180,000 / 15 years = $12,000",
    },
    {
      id: "req-asset-loss",
      order: 5,
      type: "numeric",
      label: "Asset gain or loss (enter gain as positive, loss as negative)",
      points: 1,
      correctAnswer: {
        type: "numeric",
        value: 17000,
      ...
      explanation: "Per ASC 715-30-35-22, asset gain/loss = actual return − expected return = $185,000 − $168,000 = $17,000 gain. This gain is recorded in OCI, not in pension expense.",
    },
    {
      id: "req-net-expense",
      order: 6,
      ...
      explanation: "Per ASC 715-30-35-4, net pension cost = service + interest − expected return + amortization = $195,000 + $144,000 − $168,000 + $12,000 = $183,000",
    },
    {
      id: "req-ending-pbo",
      order: 7,
      ...
      explanation: "Per ASC 715-30-35, ending PBO = beginning + service + interest − benefits paid = $2,400,000 + $195,000 + $144,000 − $150,000 = $2,589,000",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per GASB 54, nonspendable fund balance includes items not in spendable form (prepaid items) = $45,000",
    },
    {
      id: "req-restricted",
      order: 2,
      ...
      explanation: "Per GASB 54, restricted fund balance has externally enforceable constraints (state law) = $500,000",
    },
    {
      id: "req-committed",
      order: 3,
      ...
      explanation: "Per GASB 54, committed fund balance requires formal action by highest decision-making authority (council resolution) = $800,000",
    },
    {
      id: "req-assigned",
      order: 4,
      ...
      explanation: "Per GASB 54, assigned fund balance reflects intended use by management = $300,000 + encumbrances $150,000 = $450,000",
    },
    {
      id: "req-unassigned",
      order: 5,
      ...
      explanation: "Per GASB 54, unassigned is the residual classification = $3,500,000 − $45,000 − $500,000 − $800,000 − $450,000 = $1,705,000",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per GASB 33, revenue is recognized when measurable and available. Cash collected meets both criteria.",
      dropdownOptions: [
    ...
    },
    {
      ...
      explanation: "Per GASB 33, collections within 60 days of year-end meet the 'available' criterion for modified accrual",
      dropdownOptions: [
    ...
    },
    {
      ...
      explanation: "Per GASB 33, collections beyond 60 days of year-end are not 'available' under modified accrual − defer as unavailable revenue",
      dropdownOptions: [
    ...
    },
    {
      ...
      explanation: "Per GASB 33, total recognized = cash collected + available within 60 days = $9,200,000 + $500,000 = $9,700,000",
    },
    {
      ...
      explanation: "Per GASB 33, deferred inflows = amounts not available (beyond 60 days) = $300,000",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 606-10-32-28, allocate transaction price based on relative standalone selling prices. License = $180,000 × ($120,000/$220,000) = $98,182",
    },
    {
      ...
      explanation: "Per ASC 606-10-32-28, support allocation = $180,000 × ($60,000/$220,000) = $49,091",
    },
    {
      ...
      explanation: "Per ASC 606-10-32-28, upgrade allocation = $180,000 × ($40,000/$220,000) = $32,727",
    },
    {
      ...
      explanation: "Per ASC 606-10-25-27, license providing right to use IP is recognized at point in time when control transfers = $98,182",
    },
    {
      ...
      explanation: "Per ASC 606-10-25-27, support services are recognized over time as performance obligation is satisfied = $49,091 × (12/24) = $24,545",
    },
    {
      ...
      explanation: "Per ASC 606-10-25, total Year 1 revenue = license (point) + support (over time) = $98,182 + $24,545 = $122,727",
    },
  ],
};
  ...
  requirements: [
    {
      ...
      explanation: "Per ASC 740-10-25-20, depreciation timing difference is taxable (DTL). DTL = $80,000 × 25% = $20,000",
    },
    {
      id: "req-dtl-prepaid",
      order: 2,
      ...
      explanation: "Per ASC 740-10-25-20, prepaid expense timing difference is taxable (DTL). DTL = $30,000 × 25% = $7,500",
    },
    {
      id: "req-dta-warranty",
      order: 3,
      ...
      explanation: "Per ASC 740-10-25-20, warranty accrual timing difference is deductible (DTA). DTA = $75,000 × 25% = $18,750",
    },
    {
      id: "req-dta-bad-debt",
      order: 4,
      ...
      explanation: "Per ASC 740-10-25-20, bad debt allowance timing difference is deductible (DTA). DTA = $50,000 × 25% = $12,500",
    },
    {
      id: "req-dta-nol",
      order: 5,
...
// =============================================================================
// FAR-I CONTENT AREA EXPANSION (Conceptual Framework, Standard-Setting, Financial Reporting)
// =============================================================================

// Qualitative Characteristics of Useful Financial Information
export const farQualitativeCharacteristicsTBS: TBSQuestion = {
  id: "tbs-far-087",
  section: "FAR",
  tbsType: "dropdown",
  ...
  scenarioText: `You are reviewing several accounting decisions made by Pinnacle Corporation's accounting department. For each situation, identify which qualitative characteristic of useful financial information is most relevant.

Review the FASB Conceptual Framework guidance on fundamental and enhancing qualitative characteristics.`,
  timeEstimateMinutes: 10,
  maxScorePoints: 5,
  exhibits: [
    {
      id: "exhibit-framework",
      order: 1,
      title: "Qualitative Characteristics Overview",
      type: "text",
      content: {
        type: "text",
        ...
        paragraphs: [
          ...
          "• Relevance - Information capable of making a difference in decisions (includes predictive value and confirmatory value)",
  ...
  requirements: [
    {
      ...
      order: 1,
      type: "dropdown",
      label: "Pinnacle changed its depreciation method from double-declining to straight-line and disclosed both the old and new depreciation amounts",
      points: 1,
      dropdownOptions: [
        { id: "opt-relevance", order: 1, text: "Relevance", isCorrect: false },
        { id: "opt-faithful", order: 2, text: "Faithful Representation", isCorrect: false },
        { id: "opt-comparability", order: 3, text: "Comparability", isCorrect: true },
        { id: "opt-timeliness", order: 4, text: "Timeliness", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-comparability" },
      explanation: "Disclosing both amounts helps users compare across periods, enhancing comparability.",
    },
    {
      id: "req-scenario2",
      order: 2,
      type: "dropdown",
      label: "The company included detailed footnotes explaining its revenue recognition policy to help investors understand the financial statements",
      points: 1,
      dropdownOptions: [
        { id: "opt-relevance2", order: 1, text: "Relevance", isCorrect: false },
        { id: "opt-faithful2", order: 2, text: "Faithful Representation", isCorrect: false },
        { id: "opt-verifiability2", order: 3, text: "Verifiability", isCorrect: false },
        { id: "opt-understandability2", order: 4, text: "Understandability", isCorrect: true },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-understandability2" },
      explanation: "Clear explanations enhance understandability for users.",
    },
    {
      id: "req-scenario3",
      order: 3,
      type: "dropdown",
      label: "Management estimated the fair value of goodwill using discounted cash flows with clearly documented assumptions that an independent auditor could verify",
      points: 1,
      dropdownOptions: [
        { id: "opt-relevance3", order: 1, text: "Relevance", isCorrect: false },
        { id: "opt-verifiability3", order: 2, text: "Verifiability", isCorrect: true },
        { id: "opt-timeliness3", order: 3, text: "Timeliness", isCorrect: false },
        { id: "opt-comparability3", order: 4, text: "Comparability", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-verifiability3" },
      explanation: "When different observers can reach consensus on an estimate, it demonstrates verifiability.",
    },
    {
      id: "req-scenario4",
      order: 4,
      type: "dropdown",
      label: "The company recorded an impairment loss that reflects all known information without bias toward either overstating or understating assets",
      points: 1,
      dropdownOptions: [
        { id: "opt-faithful4", order: 1, text: "Faithful Representation", isCorrect: true },
        { id: "opt-relevance4", order: 2, text: "Relevance", isCorrect: false },
        { id: "opt-comparability4", order: 3, text: "Comparability", isCorrect: false },
        { id: "opt-verifiability4", order: 4, text: "Verifiability", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-faithful4" },
      explanation: "Complete information without bias reflects faithful representation (neutrality component).",
    },
    {
      id: "req-scenario5",
      order: 5,
      type: "dropdown",
      label: "The company disclosed a material contingent liability because users would want this information to predict future cash flows",
      points: 1,
      dropdownOptions: [
        { id: "opt-relevance5", order: 1, text: "Relevance", isCorrect: true },
        { id: "opt-faithful5", order: 2, text: "Faithful Representation", isCorrect: false },
        { id: "opt-timeliness5", order: 3, text: "Timeliness", isCorrect: false },
        { id: "opt-understandability5", order: 4, text: "Understandability", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-relevance5" },
      explanation: "Information with predictive value that can make a difference in decisions is relevant.",
    },
  ],
};

// Recognition and Measurement Concepts
export const farRecognitionMeasurementTBS: TBSQuestion = {
  id: "tbs-far-088",
  section: "FAR",
  tbsType: "dropdown",
  topic: "Conceptual Framework",
  subtopic: "Recognition and Measurement",
  difficulty: "medium",
  skillLevel: "analysis",
  contentArea: "FAR-I",
  title: "Recognition and Measurement Concepts",
  scenarioText: `Horizon Manufacturing is evaluating several transactions to determine proper recognition and measurement treatment under US GAAP. Apply the FASB Conceptual Framework to determine the appropriate accounting treatment.`,
  timeEstimateMinutes: 12,
  maxScorePoints: 6,
  exhibits: [
    {
      id: "exhibit-recognition",
      order: 1,
      title: "Recognition Criteria",
      type: "text",
      content: {
        type: "text",
        title: "Recognition and Measurement Guidance",
        paragraphs: [
          "Recognition Criteria (must meet all):",
          "1. Definition - Item meets definition of an element (asset, liability, etc.)",
          "2. Measurability - Item can be measured with sufficient reliability",
          "3. Relevance - Information is capable of making a difference",
          "4. Faithful Representation - Can be depicted faithfully",
          "",
          "Measurement Attributes:",
          "• Historical cost - Original acquisition price",
          "• Current cost - Cost to acquire equivalent today",
  ...
  requirements: [
    {
      ...
      order: 1,
      type: "dropdown",
      label: "Horizon received a purchase order for $500,000 of goods to be delivered next month. Should revenue be recognized now?",
      points: 1,
      dropdownOptions: [
        { id: "opt-yes-recognize", order: 1, text: "Yes - recognize revenue when order received", isCorrect: false },
        { id: "opt-no-performance", order: 2, text: "No - performance obligation not satisfied", isCorrect: true },
        { id: "opt-partial", order: 3, text: "Yes - recognize 50% as partial completion", isCorrect: false },
        { id: "opt-deferred", order: 4, text: "Yes - recognize as deferred revenue", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-no-performance" },
      explanation: "Revenue recognition requires satisfaction of performance obligations; mere receipt of an order does not meet criteria.",
    },
    {
      id: "req-asset-def",
      order: 2,
      type: "dropdown",
      label: "Horizon paid $200,000 for employee training that will benefit operations for 3 years. Under the Conceptual Framework, this is most appropriately:",
      points: 1,
      dropdownOptions: [
        { id: "opt-capitalize", order: 1, text: "Capitalized as an intangible asset", isCorrect: false },
        { id: "opt-expense-immediately", order: 2, text: "Expensed immediately", isCorrect: true },
        { id: "opt-prepaid", order: 3, text: "Recorded as a prepaid expense", isCorrect: false },
        { id: "opt-goodwill", order: 4, text: "Added to goodwill", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-expense-immediately" },
      explanation: "Training costs lack the 'control' element required for asset recognition - employees can leave; expense immediately.",
    },
    {
      id: "req-measurement",
      order: 3,
      type: "dropdown",
      label: "Horizon holds trading securities. Which measurement attribute should be used?",
      points: 1,
      dropdownOptions: [
        { id: "opt-historical", order: 1, text: "Historical cost", isCorrect: false },
        { id: "opt-fair-value", order: 2, text: "Fair value", isCorrect: true },
        { id: "opt-nrv", order: 3, text: "Net realizable value", isCorrect: false },
        { id: "opt-pv", order: 4, text: "Present value", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-fair-value" },
      explanation: "Trading securities are measured at fair value with changes in income under ASC 320.",
    },
    {
      id: "req-liability",
      order: 4,
      type: "dropdown",
      label: "Horizon is defending a lawsuit. Legal counsel believes it is probable the company will lose and estimates damages of $800,000-$1,200,000 with no amount more likely. What amount should be accrued?",
      points: 1,
      dropdownOptions: [
        { id: "opt-zero", order: 1, text: "$0 - disclose only", isCorrect: false },
        { id: "opt-low", order: 2, text: "$800,000", isCorrect: true },
        { id: "opt-mid", order: 3, text: "$1,000,000", isCorrect: false },
        { id: "opt-high", order: 4, text: "$1,200,000", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-low" },
      explanation: "When no amount in a range is more likely, accrue the minimum amount ($800,000) per ASC 450.",
    },
    {
      id: "req-inventory",
      order: 5,
      type: "dropdown",
      label: "Horizon's inventory has a cost of $300,000 and NRV of $275,000. Under GAAP, inventory should be measured at:",
      points: 1,
      dropdownOptions: [
        { id: "opt-cost", order: 1, text: "$300,000 (cost)", isCorrect: false },
        { id: "opt-nrv", order: 2, text: "$275,000 (NRV)", isCorrect: true },
        { id: "opt-average", order: 3, text: "$287,500 (average)", isCorrect: false },
        { id: "opt-replacement", order: 4, text: "Replacement cost", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-nrv" },
      explanation: "Inventory is measured at lower of cost or NRV; write down to $275,000.",
    },
    {
      id: "req-derecognition",
      order: 6,
      type: "dropdown",
      label: "Horizon sold accounts receivable to a factor without recourse and surrendered control. The receivables should be:",
      points: 1,
      dropdownOptions: [
        { id: "opt-keep", order: 1, text: "Kept on balance sheet as secured borrowing", isCorrect: false },
        { id: "opt-derecognize", order: 2, text: "Derecognized as a sale", isCorrect: true },
        { id: "opt-partial-derec", order: 3, text: "Partially derecognized", isCorrect: false },
        { id: "opt-consolidate", order: 4, text: "Consolidated with factor", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-derecognize" },
      explanation: "When control is surrendered and no continuing involvement, derecognition as a sale is appropriate.",
    },
  ],
};

// Financial Statement Elements
export const farFinancialStatementElementsTBS: TBSQuestion = {
  id: "tbs-far-089",
  section: "FAR",
  tbsType: "dropdown",
  topic: "Conceptual Framework",
  ...
  skillLevel: "remembering_understanding",
  contentArea: "FAR-I",
  title: "Elements of Financial Statements Classification",
  scenarioText: `Atlas Corporation has asked you to classify various items according to the FASB Conceptual Framework definitions of financial statement elements. Determine the appropriate classification for each item.`,
  timeEstimateMinutes: 8,
  maxScorePoints: 5,
  exhibits: [
    {
      ...
      content: {
        type: "text",
        title: "FASB Conceptual Framework - Elements",
        paragraphs: [
          "Assets: Probable future economic benefits obtained or controlled by an entity as a result of past transactions",
          ...
          "Revenues: Inflows from delivering goods or services in the entity's ongoing major operations",
          "Expenses: Outflows from delivering goods or services in the entity's ongoing major operations",
          ...
          "Comprehensive Income: Change in equity from non-owner sources",
        ],
      },
    },
  ],
  requirements: [
    {
      ...
      order: 1,
      type: "dropdown",
      label: "Atlas sold manufacturing equipment at a price above book value",
      points: 1,
      dropdownOptions: [
        { id: "opt-revenue1", order: 1, text: "Revenue", isCorrect: false },
        { id: "opt-gain1", order: 2, text: "Gain", isCorrect: true },
        { id: "opt-other-income1", order: 3, text: "Other comprehensive income", isCorrect: false },
        { id: "opt-equity1", order: 4, text: "Direct equity increase", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-gain1" },
      explanation: "Sale of equipment is peripheral to main operations; excess over book value is a gain.",
    },
    {
      id: "req-element2",
      order: 2,
      type: "dropdown",
      label: "Atlas received cash from customers for services to be performed next year",
      points: 1,
      dropdownOptions: [
        { id: "opt-revenue2", order: 1, text: "Revenue", isCorrect: false },
        { id: "opt-liability2", order: 2, text: "Liability (Unearned Revenue)", isCorrect: true },
        { id: "opt-asset2", order: 3, text: "Asset", isCorrect: false },
        { id: "opt-equity2", order: 4, text: "Equity", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-liability2" },
      explanation: "Cash received creates an obligation to perform services; this is a liability (unearned revenue).",
    },
    {
      id: "req-element3",
      order: 3,
      type: "dropdown",
      label: "Atlas's available-for-sale debt securities increased in fair value (unrealized)",
      points: 1,
      dropdownOptions: [
        { id: "opt-revenue3", order: 1, text: "Revenue", isCorrect: false },
        { id: "opt-gain3", order: 2, text: "Gain in net income", isCorrect: false },
        { id: "opt-oci3", order: 3, text: "Other Comprehensive Income", isCorrect: true },
        { id: "opt-equity-direct3", order: 4, text: "Direct equity adjustment", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-oci3" },
      explanation: "Unrealized gains on AFS debt securities are reported in OCI, part of comprehensive income.",
    },
    {
      id: "req-element4",
      order: 4,
      type: "dropdown",
      label: "Atlas has a signed contract giving it exclusive rights to use a patent for 10 years",
      points: 1,
      dropdownOptions: [
        { id: "opt-asset4", order: 1, text: "Asset", isCorrect: true },
        { id: "opt-liability4", order: 2, text: "Liability", isCorrect: false },
        { id: "opt-expense4", order: 3, text: "Expense", isCorrect: false },
        { id: "opt-nothing4", order: 4, text: "Not recognized", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-asset4" },
      explanation: "Patent rights provide probable future economic benefits from past transaction; this is an asset.",
    },
    {
      id: "req-element5",
      order: 5,
      type: "dropdown",
      label: "Atlas issued shares to acquire another company",
      points: 1,
      dropdownOptions: [
        { id: "opt-revenue5", order: 1, text: "Revenue", isCorrect: false },
        { id: "opt-liability5", order: 2, text: "Liability", isCorrect: false },
        { id: "opt-equity5", order: 3, text: "Equity increase", isCorrect: true },
        { id: "opt-gain5", order: 4, text: "Gain", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-equity5" },
      explanation: "Issuing stock is an owner transaction that increases equity; not an income statement item.",
    },
  ],
};

// GAAP Hierarchy and Standard Setting
export const farGAAPHierarchyTBS: TBSQuestion = {
  id: "tbs-far-090",
  section: "FAR",
  tbsType: "dropdown",
  topic: "Standard Setting",
  subtopic: "GAAP Hierarchy",
  difficulty: "medium",
  skillLevel: "application",
  contentArea: "FAR-I",
  title: "GAAP Hierarchy and Authoritative Guidance",
  scenarioText: `Summit Industries' accounting team has encountered several situations requiring research into authoritative guidance. For each scenario, identify the most appropriate source of guidance under the GAAP hierarchy.`,
  timeEstimateMinutes: 10,
  maxScorePoints: 5,
  exhibits: [
    {
      ...
      content: {
        type: "text",
        title: "Sources of Authoritative GAAP",
        paragraphs: [
          "Authoritative GAAP (FASB ASC):",
          "The FASB Accounting Standards Codification is the single source of authoritative US GAAP for nongovernmental entities.",
          "",
          "Nonauthoritative Guidance (for use when ASC doesn't address):",
          "• FASB Concepts Statements",
          "• AICPA Issues Papers",
          "• International Financial Reporting Standards (IFRS)",
          "• FASB Staff positions and implementation guidance",
          "• Industry practices and textbooks",
          "",
          "SEC Guidance (for SEC registrants):",
  ...
  requirements: [
    {
      ...
      order: 1,
      type: "dropdown",
      label: "Summit needs to determine the appropriate accounting for a complex revenue arrangement. Where should they look first?",
      points: 1,
      dropdownOptions: [
        { id: "opt-asc1", order: 1, text: "FASB ASC Topic 606", isCorrect: true },
        { id: "opt-concepts1", order: 2, text: "FASB Concepts Statements", isCorrect: false },
        { id: "opt-ifrs1", order: 3, text: "IFRS 15", isCorrect: false },
        { id: "opt-industry1", order: 4, text: "Industry practice guides", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-asc1" },
      explanation: "FASB ASC is the single authoritative source; ASC 606 covers revenue recognition.",
    },
    {
      id: "req-source2",
      order: 2,
      type: "dropdown",
      label: "The FASB ASC does not address Summit's unique transaction. What should they consult next?",
      points: 1,
      dropdownOptions: [
        { id: "opt-create2", order: 1, text: "Create own accounting policy", isCorrect: false },
        { id: "opt-nonauth2", order: 2, text: "Nonauthoritative sources (Concepts Statements, IFRS, etc.)", isCorrect: true },
        { id: "opt-ignore2", order: 3, text: "Do not record the transaction", isCorrect: false },
        { id: "opt-sec2", order: 4, text: "Contact the SEC", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-nonauth2" },
      explanation: "When ASC doesn't address an issue, entities should consider nonauthoritative guidance.",
    },
    {
      id: "req-source3",
      order: 3,
      type: "dropdown",
      label: "Summit is an SEC registrant researching quarterly reporting requirements. Which additional source must they consider?",
      points: 1,
      dropdownOptions: [
        { id: "opt-asc-only3", order: 1, text: "ASC only - SEC follows GAAP", isCorrect: false },
        { id: "opt-sec-guidance3", order: 2, text: "SEC rules, SABs, and staff guidance", isCorrect: true },
        { id: "opt-ifrs3", order: 3, text: "IFRS guidance only", isCorrect: false },
        { id: "opt-aicpa3", order: 4, text: "AICPA audit guides only", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-sec-guidance3" },
      explanation: "SEC registrants must also follow SEC rules, SABs, and staff guidance in addition to ASC.",
    },
    {
      id: "req-source4",
      order: 4,
      type: "dropdown",
      label: "Summit wants to understand the underlying concepts of asset recognition to apply to a new situation. Which source explains foundational concepts?",
      points: 1,
      dropdownOptions: [
        { id: "opt-asc4", order: 1, text: "FASB ASC", isCorrect: false },
        { id: "opt-concepts4", order: 2, text: "FASB Concepts Statements", isCorrect: true },
        { id: "opt-sab4", order: 3, text: "SEC Staff Accounting Bulletins", isCorrect: false },
        { id: "opt-audit4", order: 4, text: "AICPA Audit Guides", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-concepts4" },
      explanation: "FASB Concepts Statements explain fundamental concepts but are not authoritative GAAP.",
    },
    {
      id: "req-source5",
      order: 5,
      type: "dropdown",
      label: "Which organization is responsible for setting US GAAP for nongovernmental entities?",
      points: 1,
      dropdownOptions: [
        { id: "opt-sec5", order: 1, text: "Securities and Exchange Commission (SEC)", isCorrect: false },
        { id: "opt-fasb5", order: 2, text: "Financial Accounting Standards Board (FASB)", isCorrect: true },
        { id: "opt-aicpa5", order: 3, text: "American Institute of CPAs (AICPA)", isCorrect: false },
        { id: "opt-gasb5", order: 4, text: "Governmental Accounting Standards Board (GASB)", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-fasb5" },
      explanation: "FASB is the designated standard setter for US GAAP for nongovernmental entities.",
    },
  ],
};

// Full Set of Financial Statements
export const farFullFinancialStatementsTBS: TBSQuestion = {
  id: "tbs-far-091",
  section: "FAR",
  tbsType: "dropdown",
  topic: "Financial Statement Presentation",
  subtopic: "Full Set of Financial Statements",
  difficulty: "easy",
  skillLevel: "remembering_understanding",
  contentArea: "FAR-I",
  title: "Components of a Full Set of Financial Statements",
  scenarioText: `Emerald Corporation is preparing its annual financial statements. As the new staff accountant, you need to verify that all required components of a full set of financial statements under US GAAP are included and properly presented.`,
  timeEstimateMinutes: 8,
  maxScorePoints: 5,
  exhibits: [
    {
      id: "exhibit-statements",
      order: 1,
      title: "Financial Statements",
      type: "text",
      content: {
        type: "text",
        title: "Full Set of Financial Statements (US GAAP)",
        paragraphs: [
          "Required components:",
          ...
          "• Comparative financial statements (prior year) encouraged",
          "• Consistent presentation across periods",
          "• Adequate disclosures in notes",
        ],
      },
    },
  ],
  requirements: [
    {
      ...
      order: 1,
      type: "dropdown",
      label: "Emerald presents net income of $500,000 and other comprehensive income of $25,000 on a single continuous statement. This presentation is:",
      points: 1,
      dropdownOptions: [
        { id: "opt-required", order: 1, text: "Required by GAAP", isCorrect: false },
        { id: "opt-acceptable", order: 2, text: "Acceptable under GAAP", isCorrect: true },
        { id: "opt-prohibited", order: 3, text: "Prohibited - must be separate", isCorrect: false },
        { id: "opt-optional-oci", order: 4, text: "Acceptable only if OCI is immaterial", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-acceptable" },
      explanation: "GAAP allows either a single continuous statement or two separate consecutive statements.",
    },
    {
      id: "req-stmt2",
      order: 2,
      type: "dropdown",
      label: "Which financial statement shows operating, investing, and financing activities?",
      points: 1,
      dropdownOptions: [
        { id: "opt-balance2", order: 1, text: "Balance Sheet", isCorrect: false },
        { id: "opt-income2", order: 2, text: "Income Statement", isCorrect: false },
        { id: "opt-cashflow2", order: 3, text: "Statement of Cash Flows", isCorrect: true },
        { id: "opt-equity2", order: 4, text: "Statement of Stockholders' Equity", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-cashflow2" },
      explanation: "The Statement of Cash Flows categorizes cash flows into operating, investing, and financing.",
    },
    {
      id: "req-stmt3",
      order: 3,
      type: "dropdown",
      label: "Emerald omitted the notes to financial statements, claiming the statements speak for themselves. This is:",
      points: 1,
      dropdownOptions: [
        { id: "opt-ok3", order: 1, text: "Acceptable if statements are clear", isCorrect: false },
        { id: "opt-violation3", order: 2, text: "A GAAP violation - notes are required", isCorrect: true },
        { id: "opt-depends3", order: 3, text: "Acceptable for small companies only", isCorrect: false },
        { id: "opt-optional3", order: 4, text: "Optional under US GAAP", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-violation3" },
      explanation: "Notes are an integral part of financial statements and required for fair presentation.",
    },
    {
      id: "req-stmt4",
      order: 4,
      type: "dropdown",
      label: "The Statement of Changes in Stockholders' Equity shows all of the following EXCEPT:",
      points: 1,
      dropdownOptions: [
        { id: "opt-netincome4", order: 1, text: "Net income", isCorrect: false },
        { id: "opt-dividends4", order: 2, text: "Dividends declared", isCorrect: false },
        { id: "opt-treasury4", order: 3, text: "Treasury stock transactions", isCorrect: false },
        { id: "opt-cashbalance4", order: 4, text: "Ending cash balance", isCorrect: true },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-cashbalance4" },
      explanation: "Cash balance is shown on the balance sheet and cash flow statement, not equity statement.",
    },
    {
      id: "req-stmt5",
      order: 5,
      type: "dropdown",
      label: "Emerald changed an accounting estimate this year. Where should this change be disclosed?",
      points: 1,
      dropdownOptions: [
        { id: "opt-face5", order: 1, text: "Face of the balance sheet only", isCorrect: false },
        { id: "opt-footnotes5", order: 2, text: "Notes to financial statements", isCorrect: true },
        { id: "opt-nowhere5", order: 3, text: "No disclosure required", isCorrect: false },
        { id: "opt-mda5", order: 4, text: "Management Discussion only (not in financials)", isCorrect: false },
      ],
      correctAnswer: { type: "dropdown", correctOptionId: "opt-footnotes5" },
      explanation: "Changes in accounting estimates require disclosure in the notes per ASC 250.",
    },
  ],
};
...
export const farTBSQuestions: TBSQuestion[] = [
  ...
  // FAR-I Content Area Expansion (tbs-far-087 through tbs-far-091)
  farQualitativeCharacteristicsTBS,
  farRecognitionMeasurementTBS,
