    ...
    },
    {
      ...
      content: {
        ...
        paragraphs: [
          ...
          "ASC 606-10-25-20: A customer can benefit from a good or service if the good or service could be used, consumed, sold for an amount that is greater than scrap value, or otherwise held in a way that generates economic benefits.",
          "ASC 606-10-25-21: Factors that indicate that two or more promises to transfer goods or services are not separately identifiable include: (a) The entity provides a significant service of integrating the goods or services, (b) One or more of the goods or services significantly modifies or customizes another good or service promised in the contract.",
        ],
      },
    },
  ],
    ...
    },
    {
      ...
      content: {
        ...
        paragraphs: [
          ...
          "Section 10.33 - Best practices for tax advisors: Tax advisors should provide clients with the highest quality representation concerning Federal tax issues by adhering to best practices.",
          "Section 10.34 - Standards with respect to tax returns and documents: (a) A practitioner may not willfully, recklessly, or through gross incompetence sign a tax return or claim for refund that the practitioner knows or reasonably should know contains a position that lacks a reasonable basis. (b) For undisclosed positions, there must be substantial authority; for disclosed positions, there must be a reasonable basis.",
...
Please identify the authoritative literature that provides specific guidance on the auditor's responsibility regarding going concern evaluation and the consideration of management's plans.`,
    ...
    },
    {
      ...
      content: {
        ...
        paragraphs: [
          "AU-C Section 200 - Overall Objectives of the Independent Auditor: The auditor's overall objectives are to obtain reasonable assurance about whether the financial statements as a whole are free from material misstatement.",
          "AU-C Section 315 - Understanding the Entity and Its Environment: The auditor should obtain an understanding of the entity and its environment, including its internal control.",
          "AU-C Section 570 - The Auditor's Consideration of an Entity's Ability to Continue as a Going Concern: The auditor has a responsibility to evaluate whether there is substantial doubt about the entity's ability to continue as a going concern for a reasonable period of time. Conditions that may indicate substantial doubt include recurring operating losses, working capital deficiencies, inability to obtain financing, and loss of principal customers.",
          "AU-C Section 580 - Written Representations: The auditor should obtain written representations from management about matters material to the financial statements.",
          "AU-C Section 700 - Forming an Opinion and Reporting on Financial Statements: The auditor should form an opinion on whether the financial statements are presented fairly.",
        ],
      },
    },
  ],
