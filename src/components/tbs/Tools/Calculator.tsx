...
export default function Calculator({ isOpen, onClose }: CalculatorProps) {
  ...
  return (
    ...
    >
      {/* Header - Draggable */}
      <div
        className="flex items-center justify-between px-4 py-2 bg-gray-100 dark:bg-gray-900 cursor-grab active:cursor-grabbing"
      ...
      <div className="p-3 bg-gray-50 dark:bg-gray-900">
        {history && (
          <div className="text-xs text-gray-500 dark:text-gray-400 text-right mb-1 truncate">
            {history}
          </div>
        )}
        <div className="text-right text-2xl font-mono text-gray-900 dark:text-gray-100 truncate">
          {display}
        </div>
        {memory !== 0 && (
