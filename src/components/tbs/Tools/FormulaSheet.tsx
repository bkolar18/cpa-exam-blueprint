...
export default function FormulaSheet({ isOpen, onClose, section }: FormulaSheetProps) {
 ...
 className="w-full pl-9 pr-4 py-2 text-sm bg-gray-100 dark:bg-[var(--background)] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-800 dark:text-[var(--foreground)] placeholder-gray-500"
 />
 </div>
 </div>
 ...
 :"text-gray-500 dark:text-[var(--muted)] hover:text-gray-700 dark:hover:text-gray-300"
 }`}
 >
 Formulas
 </button>
 ...
 :"bg-gray-100 dark:bg-[var(--card-hover)] text-gray-600 dark:text-[var(--muted)] hover:bg-gray-200 dark:hover:bg-gray-600"
 }`}
 >
 {formulas[cat].name}
 </button>
 ...
 {searchQuery && (
 <div className="px-4 py-2 text-xs text-gray-500 dark:text-[var(--muted)] border-b border-gray-200">
 ...
 <div className="text-sm font-medium text-gray-800 dark:text-[var(--foreground)] mb-1">
 {item.title}
 </div>
 ...
 <div className="px-4 py-8 text-center text-gray-500 dark:text-[var(--muted)]">
 No formulas found
 </div>
 )}
 </div>
 ...
 <div key={table.title}>
 <h3 className="text-sm font-semibold text-gray-800 dark:text-[var(--foreground)] mb-2">
 {table.title}
 </h3>
 <div className="overflow-x-auto">
 <table className="w-full text-xs">
 <thead>
 <tr className="bg-gray-100 dark:bg-[var(--card-hover)]">
 {table.headers.map((h, i) => (
 <th
 key={i}
 className="px-2 py-1 text-center font-medium text-gray-600 dark:text-[var(--muted)]"
 >
 {h}
 </th>
 ))}
 ...
 <tr
 key={i}
 className="border-b border-gray-100 hover:bg-purple-50 dark:hover:bg-purple-900/20"
 >
 {row.map((cell, j) => (
 <td
 key={j}
 ...
 j === 0
 ?"font-medium text-gray-800 dark:text-[var(--foreground)]"
 :"font-mono text-gray-600 dark:text-[var(--muted)]"
 }`}
 >
