      ...
      {!isMinimized && (
        <>
          ...
          <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="relative">
              <button
                ...
                className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded flex items-center gap-1"
                title="Font size"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {showFontSizePicker && (
                <div className="dropdown-menu absolute top-full left-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg py-1 z-50">
                  {FONT_SIZES.map((fs) => (
                    <button
                      key={fs.value}
            ...
            <button
              onClick={toggleBold}
              className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded font-bold"
              title="Bold (Ctrl+B)"
            >
              B
            </button>
            ...
            <button
              ...
              className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded italic"
              title="Italic (Ctrl+I)"
            >
              I
            </button>
            ...
            <button
              ...
              className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded underline"
            ...
            <button
              ...
              className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded line-through"
              title="Strikethrough"
            >
              S
            </button>
            ...
            <div className="relative">
              ...
              {showHighlightPicker && (
                <div className="dropdown-menu absolute top-full left-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-2 z-50">
            ...
            <button
              onClick={handleClear}
              className="p-1.5 text-gray-600 dark:text-gray-400 hover:bg-red-100 dark:hover:bg-red-900/30 hover:text-red-600 dark:hover:text-red-400 rounded"
              title="Clear all"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div
            ...
            className="flex-1 p-3 text-sm text-gray-800 dark:text-gray-200 bg-yellow-50/50 dark:bg-gray-900 overflow-auto focus:outline-none"
            style={{ minHeight: 100 }}
