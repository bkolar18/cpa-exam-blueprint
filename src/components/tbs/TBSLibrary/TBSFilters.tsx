...
export const TBSFilters = memo(function TBSFilters({
 ...
 className="px-3 py-2 bg-white dark:bg-[var(--card)] border border-gray-200 rounded-lg text-sm text-gray-700 dark:text-[var(--muted-light)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent"
 >
 {tbsTypes.map((type) => (
 ...
 className="px-3 py-2 bg-white dark:bg-[var(--card)] border border-gray-200 rounded-lg text-sm text-gray-700 dark:text-[var(--muted-light)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent max-w-[200px]"
 >
 ...
 <button
 onClick={handleReset}
 className="px-3 py-2 text-sm text-gray-600 dark:text-[var(--muted)] hover:text-[var(--primary)] transition-colors flex items-center gap-1"
 >
