...
export const TBSSectionCard = memo(function TBSSectionCard({
 ...
 return (
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
 ...
 {/* Preview TBS items */}
 <div className="p-3 space-y-1 bg-gray-50 dark:bg-[var(--card)]/50">
 ...
 className="flex items-center justify-center gap-2 p-3 bg-gray-50 dark:bg-[var(--card)]/50 border-t border-gray-200 text-[var(--primary)] font-medium hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors"
 >
