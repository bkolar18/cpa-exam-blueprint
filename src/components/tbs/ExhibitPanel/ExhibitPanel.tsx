...
export default function ExhibitPanel({
 ...
 return (
 <div className="h-full flex items-center justify-center text-gray-500 dark:text-[var(--muted)]">
 ...
 <div
 ref={panelRef}
 className={`h-full flex flex-col ${isFullscreen ?"bg-white dark:bg-[var(--background)]":""}`}
 >
 {/* Tabs */}
 <ExhibitTabs
 exhibits={exhibits}
