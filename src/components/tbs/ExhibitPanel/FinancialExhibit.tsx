  ...
  return (
    <div className="p-4">
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden">
        {/* Header */}
        <div className="px-4 py-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 text-center">
          {content.companyName && (
              ...
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  {columns.map((col, index) => (
                    <th
                      key={index}
                      className="px-4 py-2 text-right text-sm font-semibold text-gray-700 dark:text-gray-300"
                    >
                      {col}
                    </th>
                  ))}
              ...
              {content.rows.map((row, rowIndex) => {
                ...
                return (
                  <tr
                    ...
                    className={`${
                      row.isTotal
                        ? "border-t-2 border-gray-400 dark:border-gray-500 bg-gray-50 dark:bg-gray-900/50"
                        : row.isSubtotal
                    ...
                    {row.values.map((value, valueIndex) => (
                      ...
                      >
                        {row.isTotal && valueIndex === row.values.length - 1 ? (
                          ...
                          <span className="border-b border-gray-400 dark:border-gray-500 pb-0.5">
                            ${formatCurrency(value)}
                          </span>
