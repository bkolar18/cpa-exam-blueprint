...
export default function TextExhibit({ content }: TextExhibitProps) {
 ...
 <h3 className="text-base font-semibold text-gray-800 dark:text-[var(--foreground)]">
 {content.title}
 </h3>
 </div>
 )}
 ...
 return (
 <h4 key={index} className="text-sm font-bold text-gray-800 dark:text-[var(--foreground)] mt-4 mb-2">
 {trimmed}
 </h4>
 );
 }
 ...
 return (
 <h4 key={index} className="text-sm font-semibold text-gray-800 dark:text-[var(--foreground)] mt-3 mb-1">
 {trimmed}
 </h4>
 );
 }
 ...
 return (
 <p key={index} className="text-gray-700 dark:text-[var(--muted-light)] leading-relaxed">
