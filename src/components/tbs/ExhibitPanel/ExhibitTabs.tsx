...
export default function ExhibitTabs({
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          ...
          return (
            <button
              ...
              className={`flex items-center space-x-1.5 px-3 py-1 text-xs font-medium whitespace-nowrap border-b-2 transition-colors ${
                isActive
                  ? "bg-white dark:bg-gray-800 text-[var(--primary)] border-[var(--primary)]"
                  : "text-gray-600 dark:text-gray-400 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-800"
              }`}
            >
              <span className={isActive ? "text-[var(--primary)]" : "text-gray-500 dark:text-gray-500"}>
