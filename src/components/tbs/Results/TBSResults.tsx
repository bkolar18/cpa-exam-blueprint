...
export default function TBSResults({
 ...
 {/* Score Summary Card */}
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-gray-200 overflow-hidden">
 ...
 <div className="px-6 py-4 grid grid-cols-4 gap-4 text-center border-b border-gray-200">
 <div>
 <div className="text-2xl font-bold text-green-600 dark:text-green-400">
 {correctCount}
 </div>
 <div className="text-sm text-gray-500 dark:text-[var(--muted)]">Correct</div>
 </div>
 <div>
 <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">
 {partialCount}
 </div>
 <div className="text-sm text-gray-500 dark:text-[var(--muted)]">Partial</div>
 </div>
 <div>
 <div className="text-2xl font-bold text-red-600 dark:text-red-400">
 {incorrectCount}
 </div>
 <div className="text-sm text-gray-500 dark:text-[var(--muted)]">Incorrect</div>
 </div>
 <div>
 <div className="text-2xl font-bold text-gray-600 dark:text-[var(--muted)]">
 {formatTime(timeSpentSeconds)}
 </div>
 <div className="text-sm text-gray-500 dark:text-[var(--muted)]">Time</div>
 </div>
 </div>
 ...
 {/* Detailed Results */}
 <div className="bg-white dark:bg-[var(--card)] rounded-xl border border-gray-200">
 ...
 <div>
 <h4 className="text-sm font-medium text-gray-800 dark:text-[var(--foreground)]">
 ...
 <span className="text-gray-400 dark:text-[var(--muted)]">
 ...
 className="px-6 py-3 bg-gray-200 dark:bg-[var(--card-hover)] text-gray-700 dark:text-[var(--muted-light)] rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
 >
 Back to Practice
 </button>
 </div>
