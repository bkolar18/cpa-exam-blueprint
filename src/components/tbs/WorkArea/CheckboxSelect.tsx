...
export default function CheckboxSelect({
 ...
 :"bg-white dark:bg-[var(--card)] border-gray-200 hover:border-blue-300 dark:hover:border-blue-600"
 ...
 className="mt-0.5 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 dark:border-[var(--border)] dark:bg-[var(--card-hover)]"
 />
