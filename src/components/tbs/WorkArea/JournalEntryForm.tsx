...
export default function JournalEntryForm({
  ...
  const renderJournalLine = (req: TBSRequirement, isDebit: boolean, index: number) => {
    ...
    return (
      <tr key={req.id} className={isDebit ? "" : "bg-gray-50/50 dark:bg-gray-900/30"}>
        {/* Line Number */}
        <td className="py-2 px-2 text-center text-sm text-gray-500 dark:text-gray-400">
          {index + 1}
        </td>
        ...
        <td className="py-2 px-2">
          <select
            ...
            className={`w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-sm focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed ${
              !isDebit ? "pl-8" : ""
            }`}
          >
          ...
          {isDebit && (
            <div className="relative">
              ...
              <input
                ...
                disabled={isSubmitted}
                className="w-full pl-7 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-right font-mono text-sm focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                placeholder="0"
              />
            </div>
          )}
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <th className="py-2 px-2 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 w-12">
                  #
                </th>
                <th className="py-2 px-2 text-left text-xs font-semibold text-gray-600 dark:text-gray-400">
                  Account
                </th>
                <th className="py-2 px-2 text-right text-xs font-semibold text-gray-600 dark:text-gray-400 w-32">
                  Debit
                </th>
                <th className="py-2 px-2 text-right text-xs font-semibold text-gray-600 dark:text-gray-400 w-32">
                  Credit
            ...
            <tbody>
              ...
              <tr className="border-t-2 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900">
                ...
                <td className="py-3 px-2 text-right text-sm font-semibold text-gray-700 dark:text-gray-300">
                  Totals:
                </td>
                <td className="py-3 px-2">
                  <div className="text-right font-mono text-sm font-semibold text-gray-800 dark:text-gray-200">
