...
`;
 ...
 <span className="text-xs text-gray-500 dark:text-[var(--muted)]">Templates:</span>
 ...
 :"bg-gray-100 dark:bg-[var(--card-hover)] text-gray-700 dark:text-[var(--muted-light)] hover:bg-gray-200 dark:hover:bg-gray-600"
 }`}
 >
 ...
 isSubmitted
 ?"bg-gray-100 dark:bg-[var(--card)] border-gray-300 dark:border-[var(--border)]"
 :"bg-white dark:bg-[var(--card)] border-gray-300 dark:border-[var(--border)] focus:ring-2 focus:ring-blue-500 focus:border-transparent"
 }`}
 ...
 {/* Footer with counts */}
 <div className="p-3 border-t border-gray-200 bg-gray-50 dark:bg-[var(--background)]">
 ...
 <span className="text-xs text-gray-500 dark:text-[var(--muted)] ml-2">
 ...
 {/* Progress Bar */}
 <div className="mt-2 h-2 bg-gray-200 dark:bg-[var(--card-hover)] rounded-full overflow-hidden">
 <div
 ...
 <div className="p-3 bg-gray-50 dark:bg-[var(--card)] rounded-lg">
 <p className="font-medium text-gray-700 dark:text-[var(--muted-light)]">Organization</p>
 <p className="text-gray-500 dark:text-[var(--muted)] mt-1">
 Clear structure with introduction, body, and conclusion
 </p>
 </div>
 <div className="p-3 bg-gray-50 dark:bg-[var(--card)] rounded-lg">
 <p className="font-medium text-gray-700 dark:text-[var(--muted-light)]">Development</p>
 <p className="text-gray-500 dark:text-[var(--muted)] mt-1">
 Relevant content that addresses the topic completely
 </p>
 </div>
 <div className="p-3 bg-gray-50 dark:bg-[var(--card)] rounded-lg">
 <p className="font-medium text-gray-700 dark:text-[var(--muted-light)]">Expression</p>
 <p className="text-gray-500 dark:text-[var(--muted)] mt-1">
 Professional tone with proper grammar and spelling
 </p>
 </div>
 <div className="p-3 bg-gray-50 dark:bg-[var(--card)] rounded-lg">
 <p className="font-medium text-gray-700 dark:text-[var(--muted-light)]">Word Choice</p>
 <p className="text-gray-500 dark:text-[var(--muted)] mt-1">
