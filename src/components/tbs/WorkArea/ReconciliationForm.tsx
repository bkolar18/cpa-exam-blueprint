...
function ReconciliationSection({
 ...
 <span className="text-sm text-gray-700 dark:text-[var(--muted-light)] pl-4">
 {isDeduction &&"("}
 {item.label}
 {isDeduction &&")"}
 </span>
 ...
 <span className="w-32 text-right text-sm text-gray-600 dark:text-[var(--muted)]">
 ...
 {/* Section Header */}
 <div className="px-4 py-3 bg-gray-100 dark:bg-[var(--background)] border-b border-gray-200">
 <h4 className="font-semibold text-gray-800 dark:text-[var(--foreground)]">{title}</h4>
 </div>

 <div className="p-4">
 {/* Starting Balance */}
 <div className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-[var(--border)]">
 <span className="text-sm font-medium text-gray-800 dark:text-[var(--foreground)]">{startingLabel}</span>
 <span className="text-sm font-medium text-gray-800 dark:text-[var(--foreground)]">
 ...
 {/* Adjusted Balance */}
 <div className="flex items-center justify-between py-3 mt-3 border-t-2 border-gray-300 dark:border-[var(--border)]">
 <span className="text-sm font-bold text-gray-800 dark:text-[var(--foreground)]">{adjustedLabel}</span>
 <span className="text-sm font-bold text-gray-800 dark:text-[var(--foreground)]">
