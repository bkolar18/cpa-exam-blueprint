...
export default function DropdownSelect({
 ...
 <span className="block text-xs text-gray-500 dark:text-[var(--muted)] mt-1 font-normal">
 {requirement.description}
 </span>
 )}
 </label>
 ...
 :"bg-white dark:bg-[var(--card)] border-gray-300 dark:border-[var(--border)] hover:border-blue-500 cursor-pointer"
 }`}
 >
 ...
 {isOpen && !isSubmitted && (
 <div
 className={`absolute z-50 w-full bg-white dark:bg-[var(--card)] border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-auto ${
