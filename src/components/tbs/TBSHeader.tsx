...
export default function TBSHeader({
  ...
  return (
    <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-3 py-1 flex-shrink-0">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* Title */}
          <h1 className="text-sm font-semibold text-gray-800 dark:text-gray-100 truncate max-w-md">
            {title}
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          {onReview && !isSubmitted && (
            <button
              onClick={onReview}
              className="px-3 py-1 text-sm rounded font-medium transition-colors bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
            >
              Review
            </button>
          )}
