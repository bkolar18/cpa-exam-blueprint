...
export default function SectionPage({
  ...
  return (
    <div>
      ...
      {/* Quick Stats */}
      <section className="py-8 bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Section Code</p>
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-900 dark:text-white">{difficulty}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Avg. Study Time</p>
              <p className="text-xl font-bold text-gray-900 dark:text-white">{averageStudyTime}</p>
            </div>
            <div>
              ...
              <div className="space-y-6">
                {studyAdvice.map((advice, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-900 dark:text-white">{advice}</p>
                  </div>
                ))}
              </div>
            </div>
