...
export default function SectionPage({
 ...
 {/* Quick Stats */}
 <section className="py-8 bg-gray-100 dark:bg-[var(--card-hover)] border-b border-gray-200">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
 <div>
 <p className="text-sm text-gray-600 dark:text-[var(--muted)]">Section Code</p>
 <p className="text-xl font-bold text-[var(--foreground)]">{name}</p>
 </div>
 <div>
 <p className="text-sm text-gray-600 dark:text-[var(--muted)]">Difficulty</p>
 <p className="text-xl font-bold text-[var(--foreground)]">{difficulty}</p>
 </div>
 <div>
 <p className="text-sm text-gray-600 dark:text-[var(--muted)]">Avg. Study Time</p>
 <p className="text-xl font-bold text-[var(--foreground)]">{averageStudyTime}</p>
 </div>
 <div>
 <p className="text-sm text-gray-600 dark:text-[var(--muted)]">Topics Covered</p>
 ...
 <div className="w-10 h-10 bg-gray-100 dark:bg-[var(--card-hover)] rounded-full flex items-center justify-center flex-shrink-0">
