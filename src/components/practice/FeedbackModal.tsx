      ...
      <div className="relative w-full max-w-md mx-4 bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
        ...
        {submitStatus === 'success' ? (
          ...
          <form onSubmit={handleSubmit} className="p-6">
            <p className="text-sm text-[var(--muted)] dark:text-gray-400 mb-4">
                ...
                <label
                  ...
                  className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${
                    feedbackType === type.value
                      ...
                      : 'border-[var(--border)] dark:border-gray-600 hover:border-[var(--primary)]/50'
                  }`}
                >
                  <input
                    type="radio"
                  ...
                  <div>
                    ...
                    <span className="text-sm text-[var(--muted)] dark:text-gray-400">
                      {type.description}
                    </span>
                  </div>
                </label>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 rounded-lg border border-[var(--border)] dark:border-gray-600
