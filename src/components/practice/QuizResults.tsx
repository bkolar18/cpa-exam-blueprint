...
export default function QuizResults({
 ...
 variant="compact"
 />
 <svg className="w-5 h-5 text-gray-400 dark:text-[var(--muted)]"fill="none"stroke="currentColor"viewBox="0 0 24 24">
 ...
 className="flex-1 py-3 px-6 bg-[var(--card)] dark:bg-[var(--card-hover)] text-[var(--foreground)] rounded-lg font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-center"
 >
 Back to Practice
 </Link>
 </div>
