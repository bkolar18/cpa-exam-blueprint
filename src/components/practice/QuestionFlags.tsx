...
const flagOptions = [
 ...
 inactiveColor:"bg-gray-100 dark:bg-[var(--card-hover)] text-gray-600 dark:text-[var(--muted)] hover:bg-blue-100 dark:hover:bg-blue-900/30",
 ...
 inactiveColor:"bg-gray-100 dark:bg-[var(--card-hover)] text-gray-600 dark:text-[var(--muted)] hover:bg-red-100 dark:hover:bg-red-900/30",
 ...
 inactiveColor:"bg-gray-100 dark:bg-[var(--card-hover)] text-gray-600 dark:text-[var(--muted)] hover:bg-green-100 dark:hover:bg-green-900/30",
