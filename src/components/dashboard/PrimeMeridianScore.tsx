            ...
            {result.overallScore < PRIME_MERIDIAN_CONFIG.RECOMMENDED_SCORE && (
              <div className="mt-4 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
                ...
                <p className="text-xs text-emerald-700 dark:text-emerald-300 mt-1">
                  We grade conservatively. Students who reach an 80 on Meridian are generally well-prepared for their section.
                </p>
              </div>
            )}
            ...
            {result.readinessAssessment.isReady && (
              <div className="mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-xs text-green-700 dark:text-green-300 mt-1">
                  You&apos;ve achieved excellent coverage across all content areas.
                </p>
              </div>
            )}
          </div>
