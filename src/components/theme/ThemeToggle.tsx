...
export function ThemeToggle({ showLabel = false, className = '' }: ThemeToggleProps) {
 ...
 >
 <CurrentIcon className="w-5 h-5 text-[var(--foreground)] dark:text-[var(--foreground)]"/>
 {showLabel && (
 <span className="text-sm text-[var(--foreground)] dark:text-[var(--foreground)]">
 {currentTheme.label}
 </span>
 )}
 <ChevronDownIcon className="w-4 h-4 text-[var(--muted)] dark:text-[var(--muted)]"/>
 </button>
