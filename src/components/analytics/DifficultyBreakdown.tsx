...
export default function DifficultyBreakdown({ data }: DifficultyBreakdownProps) {
 ...
 if (totalQuestions === 0) {
 return (
 <div className="flex items-center justify-center h-[300px] text-gray-500 dark:text-[var(--muted)]">
 No data available
 </div>
 );
 }
 ...
 <span className="text-sm text-gray-500 dark:text-[var(--muted)]">
 {d.total} questions ({percentage}%)
 </span>
 </div>
 <div className="flex items-center gap-3">
 <div className="flex-1 h-2 bg-gray-200 dark:bg-[var(--card-hover)] rounded-full overflow-hidden">
 <div
 ...
 <span className="text-sm font-medium text-gray-700 dark:text-[var(--muted-light)] w-12 text-right">
 {accuracy}%
 </span>
 </div>
 </div>
