...
function getHeatmapColor(accuracy: number, attempted: number): string {
  if (attempted === 0) return 'bg-gray-100 dark:bg-gray-800';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-gray-600 dark:text-gray-400">50-60%</span>
        </div>
        <div className="flex items-center gap-1">
          <div className="w-4 h-4 rounded bg-yellow-400" />
          <span className="text-xs text-gray-600 dark:text-gray-400">60-70%</span>
        </div>
        <div className="flex items-center gap-1">
          <div className="w-4 h-4 rounded bg-green-400" />
          <span className="text-xs text-gray-600 dark:text-gray-400">70-80%</span>
        </div>
        <div className="flex items-center gap-1">
