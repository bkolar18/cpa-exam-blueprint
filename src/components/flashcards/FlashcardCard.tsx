...
export default function FlashcardCard({
 ...
 {/* Front */}
 <div
 className="absolute inset-0 bg-white dark:bg-[var(--card)] rounded-2xl shadow-lg border border-gray-200 p-8 flex flex-col backface-hidden"
 ...
 <p className="text-xl text-center text-gray-800 dark:text-[var(--foreground)] font-medium whitespace-pre-wrap">
 {card.front}
 </p>
 </div>
 ...
 <kbd className="px-2 py-1 bg-gray-100 dark:bg-[var(--card-hover)] rounded text-xs">Space</kbd>
 ...
 {/* Back */}
 <div
 className="absolute inset-0 bg-white dark:bg-[var(--card)] rounded-2xl shadow-lg border border-gray-200 p-8 flex flex-col backface-hidden rotate-y-180"
 style={{
 ...
 <p className="text-lg text-gray-800 dark:text-[var(--foreground)] whitespace-pre-wrap">
 {card.back}
 </p>
 </div>
